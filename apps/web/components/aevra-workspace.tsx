...
import { dialogPop, overlayFade, pageItem, pageStage, variantSwap } from "@/lib/motion";
...
export function AevraWorkspace() {
  ...
  // Cursor-follow glow on the composer card — reads the pointer position as
  // percentages and hands them to CSS via custom properties, so the actual
  // glow (opacity, blur, fade) stays fully CSS-driven and free of re-renders.
  const handleComposerGlow = (event: MouseEvent<HTMLElement>) => {
    ...
    <MotionConfig reducedMotion="user">
      <main className="app-shell">
        ...
        <section className="main-panel">
          ...
          <motion.div className="content" variants={pageStage} initial="hidden" animate="show">
            <motion.div className="page-heading" variants={pageItem}>
              <div>
                <p className="eyebrow">
            ...
            <motion.section
              ...
              variants={pageItem}
              onMouseMove={handleComposerGlow}
            >
            ...
            <motion.section className="approval-strip" variants={pageItem}>
                ...
                <div className="review-layout">
                  ...
                  <AnimatePresence mode="wait">
                    <motion.article
                      ...
                      key={reviewVariants[activeVariant].platform}
