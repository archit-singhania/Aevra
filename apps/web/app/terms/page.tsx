  ...
  return (
    <main className="legal-page">
      ...
      <p>
        ...
        source material, approvals, publishing decisions, platform policies, and generated content.
      </p>
      <h2>Provider access</h2>
      <p>
        Only connect accounts you control. Keep provider permissions minimal and revoke access when
